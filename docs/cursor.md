...
1. Run `npx devflow-agent-cli init --adapter cursor`
...
- [ ] Run `npx devflow-agent-cli init --adapter cursor` in the repository root
...
- If you want Cursor explicitly, run `npx devflow-agent-cli init --adapter cursor`
...
```sh
npx devflow-agent-cli init --adapter cursor --dry-run
npx devflow-agent-cli init --adapter cursor --merge
npx devflow-agent-cli init --adapter cursor --force
```
